...
Load2_DATA_LOG_PATH = "./output/data/"
Load2_CAPTURE_PATH = "./output/capture/"
...
try:
    ...
    automator.set_data_logger_path(Load2_DATA_LOG_PATH)
    automator.set_capture_path(Load2_CAPTURE_PATH)
