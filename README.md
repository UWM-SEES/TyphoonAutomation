# TyphoonAutomation
*This project is an early work in progress.  See the **Contributing** section below!*
...
## Goals
The goal of this project is to create a tool which can automate the interaction with [Typhoon HIL](https://www.typhoon-hil.com/) simuluations.  Its primary features should include:
